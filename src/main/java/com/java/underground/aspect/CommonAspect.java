...
import com.java.underground.form.AbstractForm;
import com.java.underground.form.UserActionForm;
import com.java.underground.util.SynchToken;
import com.java.underground.util.SynchTokenUtil;
...
//        System.out.println("Hello aspectj");
    ...
    @Before("com.java.underground.aspect.PointcutArchitecture.inFormAction() && " +
            "args(*,form,request,..)")
